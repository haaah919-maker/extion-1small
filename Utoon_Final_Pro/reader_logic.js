    ...
    document.body.innerHTML = `
        <div id="u-reader-main" style="background-color: #0a1014; color: #e2d9f3; display: flex; flex-direction: column; min-height: 100vh; position: relative; z-index: 9999999; padding: 0; font-family: sans-serif; align-items: center; overflow-x: hidden;">
            ...
            <div id="header-controls" style="position: sticky; top: 0; width: 100%; background: rgba(10, 5, 25, 0.9); border-bottom: 2px solid #7c3aed; box-shadow: 0 4px 30px rgba(0, 0, 0, 0.5); z-index: 10000001; display: flex; flex-wrap: wrap; justify-content: center; align-items:center; gap: 12px; backdrop-filter: blur(12px); -webkit-backdrop-filter: blur(12px);">
                <div style="display:flex; gap:5px;"><button id="nav-prev-h" class="u-nav-btn" aria-label="Previous Chapter" title="Previous Chapter">Back</button><button id="nav-next-h" class="u-nav-btn" aria-label="Next Chapter" title="Next Chapter">Next</button></div>
                <div class="u-divider"></div>
                <div class="u-control-group"><span class="u-label">THEME:</span><select id="theme-select" class="u-select" aria-label="Select Theme"><option value="default">Galaxy</option><option value="grey">Grey</option><option value="black">Noir</option><option value="manga">Manga Cover</option><option value="custom">Custom UI</option></select><input type="file" id="u-bg-upload" accept="image/*" style="display:none;"></div>
                <div class="u-control-group"><span class="u-label">EFFECT:</span><select id="effect-select" class="u-select" aria-label="Select Effect"><option value="none">None</option><option value="snow">Snow ❄</option><option value="hearts">Hearts ❤️</option><option value="sparkles">Sparkles ✨</option><option value="sakura">Sakura 🌸</option><option value="action">Action 🔥</option><option value="matrix">Matrix 🟢</option><option value="rain">Rain 🌧️</option><option value="thunder">Thunder ⚡</option></select></div>
                <div class="u-control-group"><button id="auto-scroll-btn" aria-label="Toggle Auto-Scroll" title="Toggle Auto-Scroll" style="background:none; border:none; color:white; cursor:pointer; font-size:11px; font-weight:bold; display:flex; align-items:center; gap:5px;"><span id="scroll-icon">▶</span> SCROLL</button><input type="range" id="scroll-speed" aria-label="Auto-Scroll Speed" min="1" max="10" value="2" style="width:50px; accent-color:#7c3aed;"></div>
                <div style="display:flex; gap:6px;"><button id="btn-zip" class="u-action-btn" aria-label="Download as ZIP" title="Download as ZIP" style="background: #7c3aed;">ZIP</button><button id="btn-pdf" class="u-action-btn" aria-label="Download as PDF" title="Download as PDF" style="background: #db2777;">PDF</button></div>
            ...
            <div id="img-container" style="max-width:850px; width:100%; margin:20px 0; background: rgba(0,0,0,0.4); box-shadow: 0 0 60px rgba(0,0,0,0.8); border-radius: 12px; overflow: hidden; position:relative; z-index:1;">
                ...
                <div id="footer-nav" style="padding: 40px 20px; display: flex; justify-content: center; gap: 20px; background: rgba(10, 5, 25, 0.9); border-top: 2px solid #7c3aed;"><button id="nav-prev-f" class="u-footer-nav-btn" aria-label="Previous Chapter" title="Previous Chapter">Back</button><button id="nav-next-f" class="u-footer-nav-btn" aria-label="Next Chapter" title="Next Chapter" style="background: #7c3aed;">Next</button></div>
            </div>
